...
export default function NotFound(){
    return(
        <div className="flex flex-col items-center md:items-left justify-center h-[120vh] bg-brandgray bg-[url(/pattern.png)] md:bg-right-center">
            <div className="flex flex-col justify-evenly items-center rounded-2xl w-[85%] md:w-[60%] h-[40%] md:h-[65%] bg-black">
